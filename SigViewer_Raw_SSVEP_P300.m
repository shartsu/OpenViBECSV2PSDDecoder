...
plot(t(idx <= CutoffPlots), AveragedEEG_Filt_SSVEP(idx <= CutoffPlots), 'b-.');
hold on
plot(t(idx > CutoffPlots & idx <= StimulationPointsArray(1)),...
    AveragedEEG_Filt_SSVEP(idx > CutoffPlots & idx <= StimulationPointsArray(1)));
hold on
plot(t(idx > StimulationPointsArray(1) & idx <= StimulationPointsArray(1)+CutoffPlots),...
    AveragedEEG_Filt_SSVEP(idx > StimulationPointsArray(1) & idx <= StimulationPointsArray(1)+CutoffPlots), 'b-.');
hold on
plot(t(idx > StimulationPointsArray(1)+CutoffPlots & idx <= StimulationPointsArray(2)),...
    AveragedEEG_Filt_SSVEP(idx > StimulationPointsArray(1)+CutoffPlots & idx <= StimulationPointsArray(2)));
hold on
plot(t(idx > StimulationPointsArray(2) & idx <= StimulationPointsArray(2)+CutoffPlots),...
    AveragedEEG_Filt_SSVEP(idx > StimulationPointsArray(2) & idx <= StimulationPointsArray(2)+CutoffPlots), 'b-.');
hold on
plot(t(idx > StimulationPointsArray(2)+CutoffPlots & idx <= StimulationPointsArray(3)),...
    AveragedEEG_Filt_SSVEP(idx > StimulationPointsArray(2)+CutoffPlots & idx <= StimulationPointsArray(3)));
hold on
plot(t(idx > StimulationPointsArray(3) & idx <= StimulationPointsArray(3)+CutoffPlots),...
    AveragedEEG_Filt_SSVEP(idx > StimulationPointsArray(3) & idx <= StimulationPointsArray(3)+CutoffPlots), 'b-.');
hold on
plot(t(idx > StimulationPointsArray(3)+CutoffPlots & idx <= StimulationPointsArray(4)),...
    AveragedEEG_Filt_SSVEP(idx > StimulationPointsArray(3)+CutoffPlots & idx <= StimulationPointsArray(4)));
hold off
