...
%NonFilter
[pxxAll,f] = pwelch(AllStimuliDuration_AveragedEEG.', Window, Overlap, Scale ,Fs);
[pxxD1,f] = pwelch(Stimulus1_AveragedEEG.', Window, Overlap, Scale ,Fs);
[pxxD2,f] = pwelch(Stimulus2_AveragedEEG.', Window, Overlap, Scale ,Fs);
[pxxD3,f] = pwelch(Stimulus3_AveragedEEG.', Window, Overlap, Scale ,Fs);
[pxxD4,f] = pwelch(Stimulus4_AveragedEEG.', Window, Overlap, Scale ,Fs);
